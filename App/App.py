...
from custom_resume_parser import extract_resume_data # type: ignore
...
def run():
    ...
    # (Logo, Heading, Sidebar etc)
     ...
     link = '<b>Built with Love by <a href="https://matias.me/nsfw/" style="text-decoration: none; color: #021659;">Shraddha Pandey</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Shraddha Pandey</a> through 
